<!-- PAGE 2: REPORTS PAGE SECTION - Full Theme + Charts Version -->
<section id="page-reports" class="page-section space-y-6 hidden">
    ...
    <div class="custom-card p-4 sm:p-5 rounded-2xl flex flex-col lg:flex-row gap-4 items-center justify-between">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <button class="py-2 px-5 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-emerald-500 to-emerald-400 hover-press flex items-center gap-2 shadow-soft-out-sm">
                <i data-lucide="refresh-cw" class="w-3.5 h-3.5"></i><span>تحديث</span>
            </button>
            <button class="py-2 px-5 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-pink-500 to-pink-400 hover-press flex items-center gap-2 shadow-soft-out-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="custom-card p-6 rounded-2xl flex flex-col gap-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
                <table class="custom-table text-xs">
                    <thead>
                        <tr><th class="w-10 text-center">ت</th><th>الوحدة الطبية</th><th class="text-center">المجموع</th></tr>
                    </thead>
                    <tbody>
                        <tr class="table-row"><td class="text-center">1</td><td>استشارية العيون العامة</td><td class="text-center font-bold">3375</td></tr>
                        <tr class="table-row"><td class="text-center">2</td><td>استشارية التخصصات الدقيقة</td><td class="text-center font-bold">1091</td></tr>
                        <tr class="table-row font-extrabold text-theme-pink"><td colspan="2" class="text-center">المجموع</td><td class="text-center">4566</td></tr>
                    </tbody>
                </table>
                <div id="chart-report-1" class="w-full" style="height:160px"></div>
            </div>
        </div>
        ...
        <div class="custom-card p-6 rounded-2xl flex flex-col gap-4">
            <h3 class="text-sm font-bold text-text-main flex items-center gap-2 pb-3 border-b border-slate-200/20">
                ...
                جدول (2): مراجعو الاستشارية لكل طبيب اختصاص
            </h3>
            <div id="chart-report-2" style="height:200px"></div>
            <div class="max-h-[180px] overflow-y-auto custom-scrollbar pr-1">
                <table class="custom-table text-xs">
                    <thead><tr><th class="w-8 text-center">ت</th><th>الطبيب</th><th class="text-center">المراجعون</th></tr></thead>
                    <tbody>
    ...
    <!-- ============================================================ -->
    <!-- جدول (3) و (4): التوزيع الديمغرافي الاستشاريات             -->
    <!-- ============================================================ -->
    <div class="custom-card p-6 rounded-2xl space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                <p class="text-xs font-bold text-text-main opacity-70 mb-3">داخل العراق (18 محافظة)</p>
                <div id="chart-report-3" style="height:200px"></div>
            ...
            <div>
                <p class="text-xs font-bold text-text-main opacity-70 mb-3">خارج العراق</p>
                <div id="chart-report-4" style="height:200px"></div>
                <table class="custom-table text-xs text-center mt-3">
                    <thead><tr><th>ايران</th><th>افغانستان</th><th>سوريا</th><th>مصر</th><th>نيجيريا</th><th>باكستان</th></tr></thead>
                    <tbody><tr class="table-row font-bold"><td>6</td><td>4</td><td>2</td><td>1</td><td>1</td><td>1</td></tr></tbody>
                </table>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="custom-card p-6 rounded-2xl flex flex-col gap-4">
            ...
            <div id="chart-report-5" style="height:200px"></div>
            <table class="custom-table text-xs">
                <thead><tr><th>نوع الفحص</th><th class="text-center">المجموع</th></tr></thead>
                <tbody>
                    ...
                    <tr class="table-row font-extrabold text-orange-500"><td>المجموع الكلي</td><td class="text-center">7240</td></tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="custom-card p-6 rounded-2xl flex flex-col gap-4">
            ...
            <div id="chart-report-6" style="height:200px"></div>
            <table class="custom-table text-xs">
                <thead><tr><th>البيان</th><th class="text-center">العدد</th></tr></thead>
                <tbody>
                    <tr class="table-row"><td>أعداد المراجعين للمختبر</td><td class="text-center font-bold text-theme-pink">4566</td></tr>
                    <tr class="table-row"><td>أعداد التحاليل المنجزة</td><td class="text-center font-bold text-purple-600">—</td></tr>
                </tbody>
            </table>
            <div>
                <p class="text-[10px] font-bold text-text-main opacity-50 mb-2">أنواع التحاليل:</p>
    ...
    <!-- ============================================================ -->
    <!-- جدول (7): تصنيف العمليات الجراحية                          -->
    <!-- ============================================================ -->
    <div class="custom-card p-6 rounded-2xl space-y-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            <div class="overflow-x-auto">
                <table class="custom-table text-xs text-center">
                    <thead>
                        <tr><th class="text-right">التصنيف</th><th>قطاع الصحة</th><th>العتبة الخاص</th><th>العتبة العام</th><th>المجموع</th></tr>
                    </thead>
                    <tbody>
                        <tr class="table-row"><td class="text-right">العمليات الصغرى</td><td>13</td><td>13</td><td>7</td><td class="font-bold">33</td></tr>
                        <tr class="table-row"><td class="text-right">الوسطى (حقن)</td><td>1257</td><td>0</td><td>0</td><td class="font-bold">1257</td></tr>
                        <tr class="table-row"><td class="text-right">الوسطى (ليزر)</td><td>46</td><td>41</td><td>16</td><td class="font-bold">103</td></tr>
                        ...
                        <tr class="table-row font-extrabold text-rose-500"><td class="text-right">المجموع</td><td>1464</td><td>383</td><td>155</td><td>2002</td></tr>
                    </tbody>
                </table>
            </div>
            <div id="chart-report-7" style="height:220px"></div>
        </div>
    </div>
    ...
    <div class="custom-card p-6 rounded-2xl space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div>
                <p class="text-xs font-bold text-text-main opacity-70 mb-3">خارج العراق</p>
                <div id="chart-report-8" style="height:180px"></div>
                <table class="custom-table text-xs text-center mt-3">
                    <thead><tr><th>افغانستان</th><th>سوريا</th><th>لبنان</th></tr></thead>
                    <tbody><tr class="table-row font-bold"><td>1</td><td>0</td><td>0</td></tr></tbody>
                </table>
            </div>
        </div>
    </div>
    ...
    <div class="custom-card p-6 rounded-2xl space-y-4">
        ...
        <div id="chart-report-10" style="height:280px" class="mb-4"></div>
        <div class="overflow-x-auto">
            <table class="custom-table text-center" style="font-size:10px;">
                <thead>
                    <tr>
                        <th rowspan="2">ت</th>
                        <th rowspan="2" class="text-right min-w-[130px]">الطبيب</th>
                        <th colspan="3" class="bg-yellow-500/20">صغرى</th>
                        <th colspan="3" class="bg-blue-500/20">وسطى</th>
                        <th colspan="3" class="bg-orange-500/20">كبرى</th>
                        <th colspan="3" class="bg-rose-500/20">فوق الكبرى</th>
                        <th colspan="3" class="bg-purple-500/20">خاصة</th>
                        <th rowspan="2" class="text-theme-pink">المجموع</th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr class="table-row">
                        ...
                        @foreach($vals as $v)
                        <td class="{{ $v==0?'opacity-30':'' }}">{{ $v }}</td>
                        @endforeach
                        <td class="font-extrabold text-theme-pink">{{ $total }}</td>
                    </tr>
                    @endforeach
                    <tr class="table-row font-extrabold text-rose-600">
            ...
            <p class="text-[9px] text-text-main opacity-40 mt-1.5">ص = قطاع الصحة &nbsp;|&nbsp; خ = قطاع العتبة الخاص &nbsp;|&nbsp; ع = قطاع العتبة العام</p>
        </div>
    </div>
    ...
    <!-- ============================================================ -->
    <div class="custom-card p-6 rounded-2xl space-y-5">
        <h3 class="text-sm font-bold text-text-main flex items-center gap-2 pb-3 border-b border-slate-200/20">
            <i data-lucide="user-cog" class="w-4 h-4 text-violet-500"></i>
            الإحصائية التفصيلية لكل طبيب — أيار 2026
        </h3>
        <!-- Tabs -->
        <div class="flex flex-wrap gap-2" id="doctor-tabs">
            @php
            ...
            <button onclick="showDoc({{ $id }})" id="dtab-{{ $id }}"
                class="doc-tab py-1.5 px-3 rounded-xl text-[10px] font-bold text-text-main custom-inset hover-press {{ $id==1?'!text-violet-700':'' }}">
                {{ $id }}. {{ $n }}
            </button>
            @endforeach
        </div>
        ...
        $ddetails = [
            ...
            7=>['د. بشرى سليمان علي الصقر',162,[['رفع ساد + زراعة عدسة','فوق الكبرى',135],['تعديل هطول الاجفان','كبرى',1],['تصليب القرنية','كبرى',4],['غسل حجرة','كبرى',1],['الليزر','وسطى',21],['رفع كيس دهني','صغرى',3],['رفع ورم درمويد','صغرى',1],['تسليك مجرى الدمع','صغرى',3],['رفع جسم غريب','صغرى',1],['رفع جسم غريب (خيط)','صغرى',1]]],
        ...
        $classMap=['خاصة'=>'badge-danger','فوق الكبرى'=>'badge-danger','كبرى'=>'','وسطى'=>'badge-success','صغرى'=>'badge-success'];
        @endphp

        @foreach($ddetails as $id=>[$docname,$total,$ops])
        <div id="dpanel-{{ $id }}" class="dpanel {{ $id==1?'':'hidden' }} space-y-4">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <h4 class="text-sm font-extrabold text-text-main">{{ $id }}. {{ $docname }}</h4>
                <span class="text-xs font-bold text-white bg-violet-500 px-3 py-1.5 rounded-full w-fit">{{ $total }} عملية في الشهر</span>
            </div>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
                <table class="custom-table text-xs">
                    <thead><tr><th class="w-8 text-center">ت</th><th>اسم العملية</th><th class="text-center">التصنيف</th><th class="text-center">العدد</th></tr></thead>
                    <tbody>
                        @foreach($ops as $i=>$op)
                        <tr class="table-row">
                            ...
                            <td class="text-center">
                                ...
                                @endphp
                                <span class="text-[9px] font-bold px-1.5 py-0.5 rounded-full {{ $bc[$op[1]] ?? '' }}">{{ $op[1] }}</span>
                            </td>
                ...
                <div id="chart-doc-{{ $id }}" style="height:200px"></div>
            </div>
        </div>
        @endforeach
    </div>
    ...
    <div class="custom-card p-5 rounded-2xl">
        <div class="grid grid-cols-2 gap-4 text-center text-xs text-text-main">
            <div class="border-l border-slate-200/20 pl-4 space-y-1">
                <p class="font-bold opacity-60">المهندسة</p>
                <p class="font-extrabold text-sm">سميره علي ياسين</p>
                <p class="opacity-50">مسؤول الإحصاء الطبي</p>
            </div>
            <div class="pr-4 space-y-1">
                ...
                <p class="opacity-50">مدير مركز السيدة زينب الكبرى (ع)</p>
            </div>
        </div>
    </div>
...
function showDoc(id) {
    ...
    document.querySelectorAll('.doc-tab').forEach(t => t.style.color = '');
    document.getElementById('dpanel-' + id)?.classList.remove('hidden');
    document.getElementById('dtab-' + id)?.style.setProperty('color', '#7c3aed', 'important');

    // Render chart only when tab is shown
    if (!window['chartDoc' + id]) {
        renderDocChart(id);
    }
}
...
function getThemeColors() {
    ...
    if (t==='brutal') return { bg:'#ffffff', text:'#000000' };
    if (t==='excel') return { bg:'#ffffff', text:'#323130' };
    if (t==='minimalist') return { bg:'#ffffff', text:'#171717' };
    if (t==='glass') return { bg:'rgba(255,255,255,0.55)', text:'#2e3e5c' };
    return { bg:'#eef2f7', text:'#2e3e5c' };
}

const COLORS = ['#ff4d7e','#10b981','#3b82f6','#f59e0b','#8b5cf6','#06b6d4','#f97316','#64748b','#ec4899','#84cc16','#0ea5e9','#6366f1','#d946ef','#14b8a6','#f43f5e','#a78bfa'];

// ---- CHART 1: Pie – Consultations split ----
function renderReportCharts() {
    const { bg, text } = getThemeColors();

    if(document.querySelector('#chart-report-1')) {
        new ApexCharts(document.querySelector('#chart-report-1'), {
            chart:{ type:'pie', height:160, background:'transparent', toolbar:{show:false} },
            series:[3375, 1091],
            labels:['استشارية العيون العامة','التخصصات الدقيقة'],
            colors:['#ff4d7e','#10b981'],
            legend:{ position:'bottom', labels:{colors:text}, fontSize:'10px' },
            dataLabels:{ style:{ fontSize:'10px' } }
        }).render();
    }

    // ---- CHART 2: Bar – Doctors visits ----
    if(document.querySelector('#chart-report-2')) {
        new ApexCharts(document.querySelector('#chart-report-2'), {
            ...
            xaxis:{ categories:['غياث','حمزة','ذوالفقار','منتصر','افراح','مؤيد','بشرى','عالء','نور','حيدر','حذيفه','اريج','زهراء','ايات','محمد'],labels:{style:{fontSize:'8px',colors:text}} },
            colors:COLORS,
    ...
    if(document.querySelector('#chart-report-3')) {
        new ApexCharts(document.querySelector('#chart-report-3'), {
            ...
            xaxis:{ categories:['كربلاء','بغداد','النجف','بابل','ذي قار','واسط','البصرة','القادسية','ميسان','المثنى','ديالى','كركوك','نينوى','صالح الدين','اربيل','سليمانية','الانبار','دهوك'],labels:{style:{fontSize:'7px',colors:text},rotate:-45} },
            colors:['#3b82f6'], plotOptions:{ bar:{ borderRadius:3,columnWidth:'65%' } },
            dataLabels:{enabled:false}, legend:{show:false},
            yaxis:{labels:{style:{colors:text}}}, tooltip:{theme:'light'}
        }).render();
    }

    // ---- CHART 4: Donut – Outside Iraq ----
    if(document.querySelector('#chart-report-4')) {
        new ApexCharts(document.querySelector('#chart-report-4'), {
            ...
            series:[6,4,2,1,1,1],
            labels:['ايران','افغانستان','سوريا','مصر','نيجيريا','باكستان'],
            colors:['#ff4d7e','#f59e0b','#10b981','#3b82f6','#8b5cf6','#06b6d4'],
            legend:{ position:'bottom', labels:{colors:text}, fontSize:'9px' },
            dataLabels:{ style:{ fontSize:'9px' } }
        }).render();
    }

    // ---- CHART 5: Horizontal Bar – Visual Tests ----
    if(document.querySelector('#chart-report-5')) {
        new ApexCharts(document.querySelector('#chart-report-5'), {
            chart:{ type:'bar', height:200, background:'transparent', toolbar:{show:false} },
            series:[{ name:'العدد', data:[4730,641,1444,135,67,142,61,12,8] }],
            xaxis:{ categories:['فحص البصر','قوة العدسة','OCT','سونار','FUNDUS','C.T','S.M','فلورسين','FDT'],labels:{style:{fontSize:'8px',colors:text}} },
            colors:['#f97316'], plotOptions:{ bar:{ borderRadius:4, horizontal:false, columnWidth:'60%', distributed:true } },
            legend:{show:false}, dataLabels:{enabled:false},
            yaxis:{labels:{style:{colors:text}}}, tooltip:{theme:'light'}
        }).render();
    }

    // ---- CHART 6: Radial – Lab summary ----
    if(document.querySelector('#chart-report-6')) {
        new ApexCharts(document.querySelector('#chart-report-6'), {
            chart:{ type:'radialBar', height:200, background:'transparent', sparkline:{enabled:true} },
            series:[100],
            colors:['#8b5cf6'],
            plotOptions:{ radialBar:{ hollow:{size:'60%'}, dataLabels:{ name:{show:true,fontSize:'10px',color:text,offsetY:-5,formatter:()=>'مراجعو المختبر'}, value:{fontSize:'18px',fontWeight:'700',color:text,offsetY:5,formatter:()=>'4566'} } } }
        }).render();
    }

    // ---- CHART 7: Stacked Bar – Surgery classification ----
    if(document.querySelector('#chart-report-7')) {
        new ApexCharts(document.querySelector('#chart-report-7'), {
            chart:{ type:'bar', height:220, background:'transparent', stacked:true, toolbar:{show:false} },
            series:[
                { name:'قطاع الصحة', data:[13,1257,46,19,128,1] },
                { name:'العتبة الخاص', data:[13,0,41,51,189,89] },
                { name:'العتبة العام', data:[7,0,16,15,117,0] }
            ],
            xaxis:{ categories:['صغرى','وسطى(حقن)','وسطى(ليزر)','كبرى','فوق الكبرى','خاصة'],labels:{style:{fontSize:'8px',colors:text}} },
            colors:['#3b82f6','#ff4d7e','#10b981'],
            plotOptions:{ bar:{ borderRadius:3, columnWidth:'50%' } },
            legend:{ position:'bottom', labels:{colors:text}, fontSize:'9px' },
            dataLabels:{enabled:false}, yaxis:{labels:{style:{colors:text}}}, tooltip:{theme:'light'}
        }).render();
    }

    // ---- CHART 8: Radial – Surgery outside Iraq ----
    if(document.querySelector('#chart-report-8')) {
        new ApexCharts(document.querySelector('#chart-report-8'), {
            ...
            series:[1,0,0],
            labels:['افغانستان','سوريا','لبنان'],
            colors:['#f59e0b','#10b981','#3b82f6'],
            legend:{ position:'bottom', labels:{colors:text}, fontSize:'9px' },
        }).render();
    }

    // ---- CHART 10: Doctors total surgeries bar ----
    if(document.querySelector('#chart-report-10')) {
        new ApexCharts(document.querySelector('#chart-report-10'), {
            chart:{ type:'bar', height:280, background:'transparent', toolbar:{show:false} },
            series:[{ name:'مجموع العمليات', data:[85,165,22,120,10,146,162,147,189,839,57,12,6,35,2,5] }],
            xaxis:{ categories:['غياث','حمزة','ذوالفقار','منتصر','افراح','مؤيد','بشرى','عالء','نور','حيدر','حذيفه','اريج','خلدون','ايات','محمد بدر','زهراء'],labels:{style:{fontSize:'8px',colors:text},rotate:-45} },
            colors:COLORS, plotOptions:{ bar:{ borderRadius:4, distributed:true, columnWidth:'65%' } },
...
function renderDocChart(id) {
    ...
    if (!el || window['chartDoc'+id]) return;
    ...
    const docNames = {
        ...
        2:['قص السائل','رفع ساد (خاصة)','رفع ساد (فوق ك)','سليكون+عدسة','زرع عدسة','زرع صمام','هطول اجفان','تصليب قرنية','غسل حجرة','رفع سليكون','ليزر','تسليك'],
        ...
        7:['رفع ساد','هطول اجفان','تصليب قرنية','غسل حجرة','ليزر','كيس دهني','ورم درمويد','تسليك','جسم غريب','جسم غريب2'],
        8:['رفع ساد','رفع ظفرة','حقن فابزمو','حقن ايليا','حقن لوسنتس','حقن افاستين','حقن كيناكورت','تخدير'],
        9:['رفع ساد','زرع عدسة','هطول اجفان','حول','رفع ظفرة','حقن ايليا','حقن افاستين','حقن كيناكورت','ليزر'],
        10:['رفع ساد','هطول اجفان','تصليب قرنية','رفع ظفرة','حقن ايليا','حقن افاستين','حقن كيناكورت','حقن اكتيليس','ليزر','كيس دهني','تسليك','جسم غريب'],
    ...
    window['chartDoc'+id] = new ApexCharts(el, {
        chart:{ type:'donut', height:200, background:'transparent', toolbar:{show:false} },
        series: docOps[id] || [1],
        labels: docNames[id] || [''],
        colors: COLORS,
        legend:{ position:'bottom', labels:{colors:text}, fontSize:'8px', show: (docOps[id]||[]).length <= 6 },
        dataLabels:{ enabled: (docOps[id]||[]).length <= 5, style:{fontSize:'9px'} },
        tooltip:{ theme:'light' }
    });
    window['chartDoc'+id].render();
}

// Run on page load + when reports page is shown
document.addEventListener('DOMContentLoaded', () => {
    // Delay to ensure the section is visible when nav loads
    setTimeout(() => {
        if (document.getElementById('page-reports') && !document.getElementById('page-reports').classList.contains('hidden')) {
            renderReportCharts();
        }
    }, 200);
});

// Hook into the SPA navigator
