...
<section id="page-reports" class="page-section space-y-6 hidden">
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <div class="custom-card p-6 rounded-2xl">
            ...
            <div class="w-full overflow-x-auto py-2">
                <svg id="svg-report-3" viewBox="0 0 584 594" class="w-full max-w-[760px] h-auto md:h-[760px] overflow-visible mx-auto">
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <div class="custom-card p-6 rounded-2xl">
            ...
            <div class="w-full overflow-x-auto py-2">
                <svg id="svg-report-8" viewBox="0 0 584 594" class="w-full max-w-[760px] h-auto md:h-[760px] overflow-visible mx-auto">
